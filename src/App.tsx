      ...
      {!sidebarOpen && (
        <div className="lg:hidden fixed top-4 left-4 z-50 print:hidden">
          <Button
            ...
            className="bg-white dark:bg-dark-surface shadow-sm border-zinc-200 dark:border-dark-border"
          >
          ...
          <div className="p-5 border-b border-zinc-200 dark:border-dark-border flex items-center justify-between transition-colors duration-200">
              ...
              <div className="bg-transparent overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (parent) {
                      parent.className =
                        "bg-blue-600 p-2 rounded-lg text-white shadow-sm ring-1 ring-blue-700/50";
            ...
            <div className="flex items-center gap-1">
              ...
              <Button
                ...
                size="icon"
                onClick={() => setSidebarOpen(false)}
                className="lg:hidden rounded-full hover:bg-zinc-200 dark:hover:bg-dark-surface-hover"
              >
          ...
          <div className="p-4 border-t border-zinc-200 dark:border-dark-border bg-zinc-50 dark:bg-transparent flex flex-col gap-4">
            <div className="flex items-center justify-end w-full">
              <div className="flex gap-1">
                <Button
                  ...
                  size="icon"
                  onClick={toggleTheme}
                  className="rounded-full hover:bg-zinc-200 dark:hover:bg-dark-surface-hover transition-transform active:scale-95"
                  title="Alternar tema"
                >
                  {theme === "light" ? (
            ...
            {currentUser?.id === "guest" && (
              <p className="text-[10px] text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 p-2 rounded border border-amber-200 dark:border-amber-800">
                Aviso: Logon anônimo desativado no Firebase. Sincronização
                limitada.
              </p>
            )}
          </div>
              ...
              <div className="max-w-6xl mx-auto space-y-8">
                <div>
                  ...
                  <p className="text-zinc-500 dark:text-zinc-400">
                    Análise de desempenho e agendamentos
                  </p>
                </div>
                <AnalyticsDashboard />
              </div>
