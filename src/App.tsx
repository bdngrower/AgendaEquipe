...
import { Calendar, CheckSquare, Settings, LogOut, Menu, X, Bell, Moon, Sun } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-zinc-50 dark:bg-dark-bg overflow-hidden font-sans">
      ...
      <div className="flex w-full h-full">
        ...
        <div className="hidden lg:flex w-80 lg:w-96 flex-col border-r border-zinc-200 dark:border-dark-border bg-white dark:bg-dark-surface shadow-sm z-10 transition-colors duration-200">
               ...
               <div className="flex items-center justify-between w-full">
                 <div className="flex items-center gap-3">
                   ...
                   <div className="flex flex-col">
                     <span className="text-sm font-semibold tracking-tight leading-tight text-zinc-900 dark:text-zinc-200">{currentUser.name}</span>
                     <span className="text-xs text-zinc-500 dark:text-zinc-500 font-medium leading-tight">{currentUser.email}</span>
                   </div>
                 </div>
